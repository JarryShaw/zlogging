...
class PType(enum.IntFlag):
    ...
    See Also:
        `Protocol Analyzers <https://docs.zeek.org/en/stable/scripts/Protocol Analyzers.html#type-DCE_RPC::PType>`__
...
class IfID(enum.IntFlag):
    ...
    See Also:
        `Protocol Analyzers <https://docs.zeek.org/en/stable/scripts/Protocol Analyzers.html#type-DCE_RPC::IfID>`__
